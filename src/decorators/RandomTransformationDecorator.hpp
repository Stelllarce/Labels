...
public:
    explicit RandomTransformationDecorator(std::unique_ptr<Label> label, const std::vector<std::unique_ptr<TextTransformation>>&  transformations, long seed = time(NULL));
