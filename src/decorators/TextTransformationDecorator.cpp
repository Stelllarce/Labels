 ...
 */
TextTransformationDecorator::TextTransformationDecorator(std::unique_ptr<Label> label, std::unique_ptr<TextTransformation> transformation)
...
std::string TextTransformationDecorator::getText() const {
    if (!getLabel() || !transformation) return "";
